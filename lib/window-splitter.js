...
module.exports = function windowChanger (state) {
  return {
    splitCurrentWindow: function splitCurrentWindow (screenId, winConstructor, winParams, axis, winId) {
      // TODO: this method needs to make a lot more sense...
      const focusedWindow = BrowserWindow.getFocusedWindow()
      const winToSplit = winId ? {id: winId} : !focusedWindow || !paneIsInGrid(focusedWindow, screenId, state)
