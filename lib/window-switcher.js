...
const { fuzzyFindAdjacentPane } = require('./find-adjacent-pane')
...
module.exports = function windowSwitcher (state) {
  return {
    switchWindow: function switchWindow (direction, crossGrid) {
      ...
      const adjacentPane = fuzzyFindAdjacentPane(pane, direction)
